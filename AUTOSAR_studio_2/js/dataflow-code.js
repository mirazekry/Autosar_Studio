...
/*                    var msg = "";
  ...
  function save() {
    ...
    */
    /*db.updateRow('project', { name: projectName }, { 'SWCsTypeArray': SWCsTypeArray }, (succ, msg) => {
...
var ImplementationDataElements = new Array();
var StructDataElements = new Array();
var ArraysConfigurations = new Array();
var ValuesConfigurations = new Array();
var SWCsTypeArray = new Array();
var implementationdataelementdiv;
var ImplementationDataTypSelectList;
var newStructDiv;
var wholeStructwindow;
...
function load() {
  ...
  db.getRows('project', { name: projectName }, (succ, result) => {
    ...
    if (succ == true) {
      ...
      ImplementationDataElements = result[0]["ImplementationDataElements"];
      StructDataElements = result[0]["StructDataElements"];
      ArraysConfigurations = result[0]["ArraysConfigurations"];
      ValuesConfigurations = result[0]["ValuesConfigurations"];
      SRInterfacesarr = result[0]["SRInterfacesarr"];
      CSInterfacesarr = result[0]["CSInterfacesarr"];
      SWCsTypeArray = result[0]["SWCsTypeArray"];
    ...
    if(ImplementationDataElements=="" || ImplementationDataElements==undefined)ImplementationDataElements=[];
    if(StructDataElements=="" || StructDataElements==undefined)StructDataElements=[];
    if(ArraysConfigurations=="" || ArraysConfigurations==undefined)ArraysConfigurations=[];
    if(ValuesConfigurations=="" || ValuesConfigurations==undefined)ValuesConfigurations=[];
    if(SWCsTypeArray=="" || SWCsTypeArray==undefined)SWCsTypeArray=[];
