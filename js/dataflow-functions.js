function showNewSoftwareComponentModal(e)
{
	...
	var SWCType = document.getElementById('SWCType');
	...
	SoftwareComponentModal.undelegate('.save-software-component','click').delegate('.save-software-component', 'click', function(){
		...
		// if ther is no error
			if(software_component_name.length == 0) {
				...
				console.log(SWCType.value);
				SWCsTypeArray.push({ name: software_component_name, type: SWCType.value });
				...
				let set =
				{
					"SWCsTypeArray": SWCsTypeArray
				};
				db.updateRow('project', where, set, (succ, msg) => {
					// succ - boolean, tells if the call is successful
					console.log("SWCsTypeArray: " + succ + "  " + msg);
				});
